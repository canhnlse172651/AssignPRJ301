            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid ">
                        <h1 class="mt-4 px-5">Create new product</h1>
                        <form id="registrationForm" action="MainServlet" method="post" onsubmit="return validateForm()">
                            ...
                            <div class="row px-5 mb-3">
                                ...
                                <textarea class="form-control mx-2" id="exampleFormControlTextarea1" name="description" rows="5" required></textarea>
                            </div>
                            <div class="row px-5 mb-3">
                                <div class="col-6">
                                    ...
                                    <div class="row mx-1">
                                        <button type="submit" 
                                                ...
                                                name="btn" value="adminAddNewProduct">Create</button>
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div id="imagePreview" style="padding: 10px; width: 100%; max-height: 200px;display: flex;
                                        ...
                                        <img id="preview" src="" style="width:auto ; max-height: 200px;object-fit: contain">
                                    </div>
                                </div>
                            </div>
                        </form>
